...
def gui():
    ...
    weather_information = tk.Label(dashboard_window, text="", background="#f7d417", foreground="#003373",
                                   font=("Helvetica", 16, "bold italic"))
    weather_information.pack(pady=20)
...
def update_weatherinformation():
    ...
    weather_information.config(text=f"Temperatuur: {temperature} Graden Celsius\n"
                                    f"Minimale Temperatuur: {min_temperature} Graden Celsius\n"
                                    f"Maximale Temperatuur: {max_temperature} Graden Celsius\n"
                                    f"Weer: {weather}")
    weather_information.after(60000, update_weatherinformation)
